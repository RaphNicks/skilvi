...
final class PagesController
{
    ...
    private static function inject(string $html, string $rel): string
    {
        ...
        $pageScripts = [
            'index.html'             => '/js/discovery.js?v=30',
            'jobs.html'              => '/js/discovery.js?v=30',
            'search.html'            => '/js/discovery.js?v=30',
            'category.html'          => '/js/discovery.js?v=30',
            'job-detail.html'        => '/js/discovery.js?v=30',
            'worker-profile.html'    => '/js/discovery.js?v=30',
            'service-detail.html'    => '/js/discovery.js?v=30',
            'saved.html'             => '/js/discovery.js?v=30',
            'account-settings.html'  => '/js/account.js?v=26',
            'post-job.html'          => '/js/client.js?v=30',
            'client-dashboard.html'  => '/js/client.js?v=30',
            'order-detail.html'      => '/js/client.js?v=30',
            'review.html'            => '/js/client.js?v=30',
            'worker-jobs.html'       => '/js/client.js?v=30',
            'worker-orders.html'     => '/js/client.js?v=30',
